...
<script type="text/javascript" src="/ajaxPro/js/ajax.js"></script>
...
function win_upload(){
	...
	<div class="container" style="width: 80%;">
		...
		<form action="<%=request.getContextPath()%>/view/member/memberPro.jsp"
			...
			<input type="hidden" name="picture"> <input type="hidden"
				name="chk">
			<div class="row">
				...
				<div class="col-9">
					<div class="form-group">
						...
						<label for="id">아이디:&nbsp;&nbsp;<span id="result">8자리
								이상 가능합니다</span></label> <input type="text" class="form-control" name="id"
							onkeyup="idChk()"> <br> <label for="pwd">비밀번호:</label>
						<input type="password" class="form-control" name="pass"> <label
							for="name">이름:</label> <input type="text" class="form-control"
							name="name"> <label for="gender">성별:</label> <label
							class="radio-inline"> </label> <input type="radio" name="gender"
							checked value="1">남 <label class="radio-inline">
